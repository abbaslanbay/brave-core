/* Copyright (c) 2019 The Minego Authors. All rights reserved.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */

// Brand-specific constants and install modes for Minego.
...
const wchar_t kCompanyPathName[] = L"MinegoInc";

#if defined(OFFICIAL_BUILD)
const wchar_t kProductPathName[] = L"Minego-Browser";
#else
const wchar_t kProductPathName[] = L"Minego-Browser-Development";
#endif
...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Minego.
    {
        ...
        .base_app_name = L"Minego",       // A distinct base_app_name.
        .base_app_id = L"Minego",         // A distinct base_app_id.
        .prog_id_prefix = L"MinegoHTML",  // ProgID prefix.
        .prog_id_description = L"Minego HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Minego Beta
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .base_app_name = L"Minego Beta",   // A distinct base_app_name.
        .base_app_id = L"MinegoBeta",      // A distinct base_app_id.
        .prog_id_prefix = L"MinegoBHTML",  // ProgID prefix.
        .prog_id_description =
            L"Minego Beta HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Minego Dev
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .base_app_name = L"Minego Dev",    // A distinct base_app_name.
        .base_app_id = L"MinegoDev",       // A distinct base_app_id.
        .prog_id_prefix = L"MinegoDHTML",  // ProgID prefix.
        .prog_id_description =
            L"Minego Dev HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Minego SxS (canary).
    {
        .size = sizeof(kInstallModes[0]),
        .index =
        ...
        .base_app_name = L"Minego Nightly",  // A distinct base_app_name.
        .base_app_id = L"MinegoNightly",     // A distinct base_app_id.
        .prog_id_prefix = L"MinegoSSHTM",    // ProgID prefix.
        .prog_id_description =
            L"Minego Nightly HTML Document",  // ProgID description.
        .active_setup_guid =
...
#else
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Minego developer build.
    {
        .size = sizeof(kInstallModes[0]),
        ...
        .logo_suffix = L"",  // No logo suffix for the primary install mode.
        .app_guid =
            L"",  // Empty app_guid since no integraion with Minego Update.
        .base_app_name = L"Minego Development",  // A distinct base_app_name.
        .base_app_id = L"MinegoDevelopment",     // A distinct base_app_id.
        .prog_id_prefix = L"MinegoDevHTM",       // ProgID prefix.
        .prog_id_description =
            L"Minego Development HTML Document",  // ProgID description.
        .active_setup_guid =
