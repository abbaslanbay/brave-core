...
const wchar_t kRegPathClients[] = L"Software\\MinegoInc\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\MinegoInc\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\MinegoInc\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\MinegoInc\\Update";
