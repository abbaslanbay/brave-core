...
provideStrings({
  ...
  braveWalletOnboardingSuccessDescription: 'To access your wallet, just click the wallet icon at the top right of any Minego Browser window.',
  ...
  braveWalletCryptoWalletsDescriptionTwo: 'If youd rather skip the import and keep the old Crypto Wallets experience, just navigate to the Minego Browser $1Settings$2 and change the default back to Crypto Wallets. You can also import, try the new Brave Wallet, and change back at any time.',
