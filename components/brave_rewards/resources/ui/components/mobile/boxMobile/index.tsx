...
export default class BoxMobile extends React.PureComponent<Props, State> {
   ...
   *
   * When user is on the index page: (minego://rewards)
   * (state) { detailView: false, settings: false }
   *
   * When user is on a detail view: (minego://rewards/ads)
   * (state) { detailView: true, settings: false }
   *
   * When user is on a settings view: (minego://rewards/ads-settings)
