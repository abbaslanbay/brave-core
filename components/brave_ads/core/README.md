...
You can enable diagnostic logging to the `Rewards.log` file stored on your device; see [Brave Rewards](minego://flags/#brave-rewards-verbose-logging). View this log file on the `Logs` tab at [rewards internals](minego://rewards-internals).

## Diagnostics

View diagnostics at [rewards internals](minego://rewards-internals) on the `Ad diagnostics` tab.
