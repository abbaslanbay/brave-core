...
provideStrings({
  ...
  braveWelcomeDesc: 'Get Minego protection on every link you click. Just set Minego as default and browse. Privately.',
  ...
  braveWelcomeSetDefaultButtonLabel: 'Set Minego as default browser',
  braveWelcomeSelectAllButtonLabel: 'Select All',
  braveWelcomeHelpImproveBraveTitle: 'Help make Minego better.',
  braveWelcomeSendReportsLabel: 'Send diagnostic reports if you experience a crash or freeze. $1Learn more.$2',
  braveWelcomeSendInsightsLabel: 'Share completely private and anonymous product insights about what features are being used by Minego\'s users. $1Learn more.$2',
  braveWelcomeSetupCompleteLabel: 'Setup complete',
  braveWelcomeChangeSettingsNote: ' Change these choices at any time in Minego at $1minego://settings/privacy$2.',
  braveWelcomePrivacyPolicyNote: 'Read our full $1Privacy Policy$2',
  braveWelcomeSelectThemeLabel: 'Choose your theme',
  braveWelcomeSelectThemeNote: 'You can change this at any time in Minego settings.',
