    ...
    kBraveShieldsAdBlockSubscriptionTrafficAnnotation =
        ...
        semantics {
          ...
          description:
            ...
            "added by users on minego://adblock."
          trigger:
            "After being registered in minego://adblock, any enabled filter "
            "list subscriptions will be updated in accordance with their "
            "`Expires` field if present, or daily otherwise. A manual refresh "
            "for a particular list can also be triggered in minego://adblock."
          data: "The URL endpoint provided by the user in minego://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "minego://adblock page's custom list subscription section."
