...
const char kBraveUIWalletOnboardingURL[] = "minego://wallet/crypto/onboarding";
const char kBraveUIWalletAccountCreationURL[] =
    "minego://wallet/crypto/accounts/add-account/create/";
...
const char kFederatedInternalsURL[] = "minego://federated-internals";
