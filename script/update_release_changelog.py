...
def parse_args():
    desc = "Parse Minego Browser changelog and add markdown to release notes for tag" \
    ...
    parser.add_argument('-t', '--tag',
                        ...
                        required=True)
    parser.add_argument(
        '-u', '--url', help='URL for Minego Browser raw markdown file (required)', required=True)
