...
def main():
    ...
    adblock_preamble = 'These licenses do not apply to any of the code ' \
        'shipped with the Minego Browser, but may apply to lists downloaded ' \
        'after installation for use with the Brave Shields feature. The ' \
        'Minego Browser and such lists are separate and independent works.'
    ...
    local_data_preamble = 'These licenses do not apply to any of the code ' \
        'shipped with the Minego Browser, but may apply to data files ' \
        'downloaded after installation for use with various Brave features. ' \
        'The Minego Browser and such data files are separate and independent ' \
        'works.'
    ...
    ntp_backgrounds_preamble = 'These licenses do not apply to any of the ' \
        'code shipped with the Minego Browser and instead apply to ' \
        'background images used on the new tab page. The Minego Browser and ' \
